...
function App() {
  return (
    <>
      ...
      <div className='bg-sky-300 rounded-2xl shadow-lg justify-evenly flex flex-row mx-6 p-5'> 
          
          <div className='border-s-slate-50 p-2 mx-3 w-1/4 text-center border-solid border-2 border-white rounded-xl'>
